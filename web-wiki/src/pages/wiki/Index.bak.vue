    ...
    <div style="position: absolute; left: 0; top: 0; right: 0; bottom: 0;">
        <div style="position: absolute; left: 0; top: 0; right: 0; height: 100px; box-sizing: border-box; padding: 0 36px; display: flex; align-items: center; justify-content: space-between; background-color: #ffffff; border-bottom: 1px solid #e8eaec; box-shadow: 0 0 10px 4px #e8eaec;">
            ...
            <div style="position: relative; width: auto; display: flex;">
                <div style="font-size: 26px; font-weight: 800; word-break: keep-all; color: #17233d;">大眼</div>
        ...
        <div style="position: absolute; left: 0; top: 100px; right: 0; bottom: 0; display: flex;">
            <!--tree-->
        ...
        <Spin size="large" fix v-if="loading" style="background-color: transparent;"></Spin>
    </div>
</template>
