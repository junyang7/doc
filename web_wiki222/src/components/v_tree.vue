                ...
                <div>
                    ...
                    <template v-if="a.hasOwnProperty('children')">
                        <div
                            ...
                            v-if="a.collapse === false" style="color: #2d8cf0; width: 24px; height: 20px; display: inline-flex; align-items: center;">
                            <i class="ri-arrow-right-s-fill"></i>
                        </div>
                        <div
                            @click.stop="collapse(a)"
                            v-if="a.collapse === true" style="color: #2d8cf0; width: 24px; height: 20px; display: inline-flex; align-items: center;">
